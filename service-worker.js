const CACHE_NAME="paibp-smart-v82-cp2025-clean-static";
...
self.addEventListener("fetch",(event)=>{
  ...
  const fresh = event.request.mode==="navigate"
    ...
    || /app-config|v38-upgrade|v39-upgrade|islamic-lite|islamic-data|islamic-learning|islamic-upgrade|khutbah|hadith|arabic|script\.js|teacher-cat|cat-session|net-v71|mobile-fix|stable-v72|quran-kemenag|quran-kemenag-runtime|worship-restore|learning-guard|cp2025-cleanup|cp2025-loader|cp2025-exact|cat-session|service-worker/i.test(url.pathname);
