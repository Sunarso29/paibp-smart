(() => {
  ...
  addStyle("v39-upgrade.css?v=39");

  ensureScript("v38-upgrade.js?v=39", () => Boolean(document.querySelector(".v38-worship-button")))
    .then(() => ensureScript("v39-upgrade.js?v=39", () => document.documentElement.dataset.portalBuild === "39-quran-worship"))
    .catch(() => {
      document.documentElement.dataset.portalBuild = "39-partial";
    });

  document.documentElement.dataset.portalBuild = "39-loader";
})();
