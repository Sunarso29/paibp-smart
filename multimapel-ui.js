(() => {
  ...
  function materialHtml(item) {
    ...
    return `<article class="multi-document-v35 multi-material-v35" data-mm-panel="material">
      ...
      <section class="multi-numbered-section-v35 multi-submit-v35"><h3><span>H</span>Simpan dan Kirim kepada Guru</h3>${identityFields()}<div class="multi-submit-actions-v35 no-print"><button type="button" data-mm-save>💾 Simpan</button><button type="button" data-mm-docx>📄 Unduh DOCX</button><button class="is-primary" type="button" data-mm-send>${svg.send} Kirim kepada guru</button></div><p data-mm-status class="multi-status-v35" aria-live="polite"></p></section><footer class="document-promo-v37"><b>PAIBP SMART SMP</b><span>Belajar • Paham • Berakhlak</span><small>https://sunarso29.github.io/paibp-smart/</small></footer>
    </article>`;
  }
